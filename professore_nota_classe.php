...
<body>
	<div class="container-content">
		...
		<?php 
			...
			if(isset($_POST["classe"])&&is_numeric($_POST["classe"])&&isset($_POST["txt"])){
				$params[0]=$_SESSION["id_professore"];
				$params[1]=validateInput($_POST["classe"]);
				$params[2]=validateInput($_POST["txt"]);
				$template="Insert into note(id_professore,id_classe,txt) values (?,?,?)";
				...
				echo "<form action=professore_nota_classe.php method=POST>";
